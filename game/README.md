...
- Durch blaue **+1**-Tore laufen → 1 Soldat mehr
- Der **gelbe Bus** ist abschießbar (HP-Balken!): erst nach seiner Zerstörung
  rollen die goldenen **+23**-Tore an — und es gibt +15 Soldaten Prämie
